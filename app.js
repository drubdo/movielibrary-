...
function edit(data) {
  ...
  let html = `
        ...
        <form>
            ...
            <button type="button" class="btn btn-info" onClick="updateRecord()">Update Record</button>
...
function generateSearchForm(columnNames) {
  $("#searchFilter").empty();
  let i = 1;
  let html =
    '<h4>Search</h4><select id="selection" onchange="clearInput()" class="form-control" width="200">';
